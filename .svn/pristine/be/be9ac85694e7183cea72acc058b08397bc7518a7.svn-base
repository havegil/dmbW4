...
export default class SignatureWrapsW1 extends Component {
	...
	componentDidMount() {
		...
		.set(this.Frame1, {left: "-450px"})
		.set(this.Frame2, {left: "-120px"})
		.set(this.Frame3, {left: "0px"})
		.set(this.Frame4, {left: "-120px"})
		
		.to(this.Frame1, 4, {left: "-450px", ease: Linear.easeNone})
