...
// Build DOM
let domClass = 'c-DeviledEgg19w4Quad'
...
export default class DeviledEgg19w4Quad extends Component
{
  ...
  componentDidMount() {
    ...
    timeline
      ...
      .fromTo(C.bg2, 3.0,
      { left: "-=100px"},{ left: "+=50px", ease: Linear.easeNone}, time)
      time += timeIncrement;
    ...
    timeline
      ...
      .fromTo(C.bg3, 3.0,
      { left: "-=50px"},{ left: "-=50px", ease: Linear.easeNone}, time)
      time += timeIncrement;
