...
export default class CauliflowerFritters extends Component {
	...
	componentDidMount() {
		...
		.set(this.Frame2, {autoAlpha: 0, left: "-50px"})
		...
		.to(this.Frame1Text1, 0.25, {autoAlpha: 1}, "+=0.5")
		.to(this.Frame1Text2, 0.25, {autoAlpha: 1})
		.to([this.Frame2, this.Frame2Text], 0.5, {autoAlpha: 1}, "+=1.5")
		.to([this.Frame3, this.Frame3Text], 0.5, {autoAlpha: 1}, "+=2")
		.to([this.Frame4, this.Frame4Text], 0.5, {autoAlpha: 1}, "+=2")
	...
	return(
		<div className="c-cauliflower-dual">
