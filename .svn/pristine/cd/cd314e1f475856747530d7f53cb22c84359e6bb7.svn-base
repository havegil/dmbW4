...
export default class CaramelAppleCookie extends Component {
    ...
    .set(this.Frame2, {top: -600, autoAlpha: 0})
    .set(this.Frame2Text1, {top: 600, left: 185, rotation: -45, autoAlpha: 0})

    .set(this.Frame2_1, {top: -1800, autoAlpha: 0})
    .set(this.Frame2Text2, {top: 2300, left: -50, autoAlpha: 0})

    .set(this.Frame3, {top: -3350, autoAlpha: 0})
    .set(this.Frame3Text1, {autoAlpha: 0, top: 3350})
    .set(this.Frame3Text2, {autoAlpha: 0, top: 3350})
    .set(this.Frame3Text3, {autoAlpha: 0, top: 3350})
    .set(this.Frame3Text4, {autoAlpha: 0, top: 3350})
    .set(this.Frame3Text5, {autoAlpha: 0, top: 3350})


    //-----------------------------------------------------------//
    	
    .to(this.Frame1Text1, 0.5, {autoAlpha: 1, top: 0}, "=+1")
    .to(this.Frame1Text2, 0.5, {autoAlpha: 1, top: 0}, "=+0.3")
    .to(this.Frame1Text3, 0.5, {autoAlpha: 1, top: 0}, "=+0.3")
    .to(this.Frame1Text4, 0.5, {autoAlpha: 1, top: 0}, "=+0.3")

    .to(this.Frame2, 0.5, {autoAlpha: 1}, "=+1")
    .to(this.Frame2Text1, 0.5, {autoAlpha: 1}, "=+0.5")

    .to(this.Frame2_1, 0.5, {autoAlpha: 1}, "=+1")
    .to(this.Frame2Text2, 0.5, {autoAlpha: 1}, "=+0.5")

    .to(this.Frame3, 0.5, {autoAlpha: 1}, "=+1")
    .to(this.Frame3Text1, 0.5, {autoAlpha: 1})
    .to(this.Frame3Text2, 0.5, {autoAlpha: 1})
    .to(this.Frame3Text3, 0.5, {autoAlpha: 1})
    .to(this.Frame3Text4, 0.5, {autoAlpha: 1})
    .to(this.Frame3Text5, 0.5, {autoAlpha: 1})
    }
	...
	render() {
		return (
            <div className="c-CaramelAppleCookie">
                ...
                <div className="frame2_1" ref={(node) => this.Frame2_1 = node}>
                    <img src={TallCookieFrame} alt="caramel apple cookies" ref={(node) => this.TallCookieFrame = node} />
