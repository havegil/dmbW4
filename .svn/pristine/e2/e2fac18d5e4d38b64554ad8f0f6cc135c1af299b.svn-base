...
export default class FreshlyMade extends Component {
    ...
    componentDidMount() {
        ...
        timeline
        .set([this.Frame1Text1,this.Frame1Text2], {autoAlpha: 0})
        .set([this.blackBG,this.TurkeyTag, this.blackBG2, this.SteakTag, this.blackBG3, this.YellowBar, this.TurkeySub2, this.SteakSub2, this.Legal, this.AmpUp, this.Build], {autoAlpha: 0})
        .set([this.TurkeySub,this.SteakSub, this.TurkeyText, this.TurkeyText2, this.SteakText, this.SteakText2], {autoAlpha: 0} )

        .set(this.Fresh, {autoAlpha: 0})
        .set(this.SteakText, {x: 0})
        .set(this.TurkeyText, {x: 0})


        //--------------------------------------------//

        .to(this.Frame1Text1, 0.5, {autoAlpha: 1}, .25)
        .to(this.Frame1Text2, 0.5, { autoAlpha: 1}, .75)
        .to([this.TurkeySub,this.blackBG], 0, {autoAlpha: 1}, 2)
        .to(this.TurkeyTag, 0.5, {autoAlpha: 1}, 2.5)
        .to(this.TurkeyTag, 0.5, {autoAlpha: 0}, 4.5)
        .to(this.AmpUp, 0.5, {autoAlpha: 1}, 4.5)

        .to([this.SteakSub,this.blackBG2], 0, {autoAlpha: 1}, 6.4)
        .to(this.SteakTag, 0.5, {autoAlpha: 1}, 7)
        .to(this.SteakTag, 0.5, {autoAlpha: 0}, 9)
        .to(this.Build, 0.5, {autoAlpha: 1}, 9.5)

        .to([this.blackBG3, this.YellowBar, this.TurkeySub2, this.SteakSub2, this.Legal], 0, {autoAlpha: 1}, 11.5)
        .to(this.Fresh, 0.5, {autoAlpha: 1}, 11.75)

        .to([this.SteakText, this.TurkeyText], 1, {autoAlpha: 1}, 12.25)
