...
export default class BeyondMeatballMarinara extends Component
{
  ...
  componentDidMount() {
    ...
    .set(this.Frame1Text1, {autoAlpha: 0, top: 0})
    .set(this.Frame1Text2, {autoAlpha: 0, top: 0})
    .set(this.Frame1Text3, {autoAlpha: 0, top: 0})
    .set(this.Frame1Text4, {autoAlpha: 0, top: 0})
    .set(this.Frame1Text5, {autoAlpha: 0, top: 0})

    .set(this.Frame2, {autoAlpha: 0})
    .set(this.MeatballSubContainer, {left: meatballEnd, top: -1100})
    ...
    .set(this.MeatballSub2, {width: "2100px", height: "1575px", left: -800, top: -350, autoAlpha: 0})
    ...
    .to(this.Frame1Text1, 0.3, {autoAlpha: 1}, "+=0.5")
    .to(this.Frame1Text2, 0.2, {autoAlpha: 1}, "+=0.75")
    .to(this.Frame1Text3, 0.2, {autoAlpha: 1}, "+=0.25")
    .to(this.Frame1Text4, 0.2, {autoAlpha: 1}, "+=0.25")
    .to(this.Frame1Text5, 0.2, {autoAlpha: 1}, "+=0.25")
    .to(this.Frame1Logo, 0.5, {autoAlpha: 1}, "+=0.5")

    .to(this.Frame2, 1, {autoAlpha: 1}, "+=1")
    .to(this.Frame3Text1, 0.5, {autoAlpha: 1})
    .to(this.Frame3Text2, 0.5, {autoAlpha: 1}, "+=0.5")

    .to(this.MeatballSub2, 0.5, {autoAlpha: 1}, "+=1.5")
    .to(this.Frame4Text1, 0.5, {autoAlpha: 1}, "+=0.75")
    .to(this.Frame4Text2, 0.5, {autoAlpha: 1}, "+=0.25")
    .to(this.Frame4Logo, 0.5, {autoAlpha: 1}, "+=0.25")
    .to(this.Frame4Text3, 0.5, {autoAlpha: 1}, "+=0.25")
    .to(this.Legal, 0.5, {autoAlpha: 1}, "+=0.25")
    ...
    return (
      ...
      <div className="c-beyond-meatball-quad">
        ...
        <div className="frame2" ref={(node) => this.Frame2 = node}>
          <div ref={(node) => this.MeatballSubContainer = node}>
        ...
        <div className="frame4">
          <img className="meatball-sub" src={MeatballSub} ref={(node) => this.MeatballSub2 = node}/>
