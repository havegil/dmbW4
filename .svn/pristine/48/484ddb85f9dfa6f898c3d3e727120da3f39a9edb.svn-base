...
@neocastDataProvider([
  ...
  'turkey_italiano_melt_price_6in',
  'turkey_italiano_melt_price_12in'
])
...
componentDidMount() {
    ...
    new TimelineMax()
      ...
      .to(this.bg5, beatLength, { left: "-=50" })

      .set(this.frame5, { autoAlpha: 0 })
      .set(this.frame6, { autoAlpha: 1 })
      .to(this.bg6, beatLength, { left: "-=50" })

      .set(this.frame6, { autoAlpha: 0 })
      .set(this.frame7, { autoAlpha: 1 })
      .to(this.bg7, 1, { top: "-=50" })

      .set(this.frame7, { autoAlpha: 0 })
      .set(this.frame8, { autoAlpha: 1 })
      .to(this.bg8, beatLength, { top: "-=50" })
  ...
  render() {
    return (
      <div className='c-Promotion-2018w5-ItalianCollection'>
        ...
        <div className="frame frame10" ref={(node) => this.frame10 = node}>
          <img src={frame10}/>
          <p className="price price1">${this.props.italian_bmt_price_6in} / ${this.props.italian_bmt_price_12in}</p>
          <p className="price price2">${this.props.spicy_italian_price_6in} / ${this.props.spicy_italian_price_12in}</p>
          <p className="price price3">${this.props.turkey_italiano_melt_price_6in} / ${this.props.turkey_italiano_melt_price_12in}</p>
        </div>
