...
// Build DOM
let domClass = 'c-KingsHawaiian_2019w4'
...
export default class KingsHawaiian_2019w4 extends Component
{
  ...
  componentDidMount() {
    ...
    timeline
      .fromTo(C.bg1, 10.0,
      { left: "-=450px"},
      { left: "+=200px", ease: Linear.easeNone}, 0)

    timeline
      .to(C.text1, 1, { autoAlpha: 0 }, 5)

    timeline
      .to(C.bg2, 0.5, { autoAlpha: 1 }, 9.5)
      .to(C.sub1Price6, 0.5, { autoAlpha: 1 }, 9.5)
      .to(C.sub2Price6, 0.5, { autoAlpha: 1 }, 9.5)
