...
export default class W7ThaiChicken extends Component
{
  ...
  componentDidMount() {
    ...
    timeline
      ...
      .set([C.sub, C.sub_text_1,C.sub_text_2,C.sub_text_3], { left: -200 }, 5)
      .to([C.frame3], 0.5, { autoAlpha: 1 }, 5.5)
      .to([C.sub_text_1], 0.5, { autoAlpha: 1 }, 5.5)



      .set([C.sub, C.sub_text_1,C.sub_text_2,C.sub_text_3], { left: -900 }, 7.0)

      .set([C.frame2], { autoAlpha: 0 }, 6)
      .to([C.sub_text_2], 0.5, { autoAlpha: 1 }, 8)

      .set([C.sub, C.sub_text_1,C.sub_text_2,C.sub_text_3], { left: -1100 }, 10)
      .to([C.sub_text_3], 0.5, { autoAlpha: 1 }, 11)

      .to([C.frame1,C.sub1_price_6,C.sub1_price_12], 0.5, { autoAlpha: 1}, 14)
      .to([C.frame3], 0.5, { autoAlpha: 0}, 14)

      // .to([C.frame1,C.sub1_price_6,C.sub1_price_12], 0.5, { autoAlpha: 0 }, 3)
      // .to([C.frame2], 0.5, { autoAlpha: 1 }, 3)
      // .to([C.sub, C.sub_text_1,C.sub_text_2,C.sub_text_3], 6, { left: -1100 }, 3)

      // .to([C.sub_text_1], 0.5, { autoAlpha: 1 }, 4)

      // .to([C.frame3], 0.5, { autoAlpha: 1 }, 6)
      // .to([C.sub_text_2], 0.5, { autoAlpha: 1 }, 6.5)


      // .to([C.sub_text_3], 0.5, { autoAlpha: 1 }, 9)
      // .to([C.frame4], 0.5, { autoAlpha: 1 }, 9)

      // .to([C.frame2,C.frame3], 0.5, { autoAlpha: 0 }, 10)

      // .to([C.frame1,C.sub1_price_6,C.sub1_price_12], 0.5, { autoAlpha: 1}, 12)
      // .to([C.frame4], 0.5, { autoAlpha: 0}, 12)
