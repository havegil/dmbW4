...
import SubImageNoKeto from './images/subs-no-keto.png'
import SubImageNoRbNoKeto from './images/subs-no-rb-no-keto.png'
...
export default class FreshFitMenuKeto2 extends Component {
  ...
  render() {
    ...
    if (this.props.decal_options == 'enable_299_decals') {
      decals6['veggie_delite'] = { decal6: '299' }
      decals6['oven_roasted'] = { decal6: '299' }
    }
    ...
    let disableKeto = (API.loc('keto_disable'))
    ...
    {
      if (isRBSkuTest) {
        bgImage = SubImageNoRbNoKeto
      } else {
        bgImage = SubImageNoKeto
      }
    }
    ...
    return (
      <div className={`c-MenuFreshKeto2 ${testType}`}>

        <img src={bgImage} className='subImage'/>
        ...
        {!isRBSkuTest &&
          <div className={`blockItems`}>
              ...
              <SubBlockItem apiKey='veggie_delite' {...decals['veggie_delite']} {...decals6['veggie_delite']}/>
              <SubBlockItem apiKey='oven_roasted_chicken' {...decals['oven_roasted']} {...decals6['oven_roasted']}/>
          </div>
        }
