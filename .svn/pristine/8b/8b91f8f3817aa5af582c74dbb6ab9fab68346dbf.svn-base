...
import bg from '../images/tuna-goddess.png'
import final from '../images/tuna-final.png'
import text from '../images/text-1.png'

// Build DOM
let domClass = 'c-TunaGoddess19w2d'

let sub1price6 = API.loc('green_goddess_tuna_price_6in')
let sub1price12 = API.loc('green_goddess_tuna_price_footlong')
...
export default class TunaGoddess19w2 extends Component
{
  ...
  componentDidMount() {
    ...
    // timeline
    //   .to(C.bg, 10,
    //   { left: "-=1420", ease: Linear.easeNone}, 1)
    ...
    // timeline
    //   .set(C.bg, { left: "-=1420", ease: Linear.easeNone}, 3)
