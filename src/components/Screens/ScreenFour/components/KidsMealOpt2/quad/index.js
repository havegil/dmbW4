...
export default class KidsMealQuad extends Component {
  ...
  componentDidMount() {
    ...
    new TimelineMax()
      ...
      .set(this.mini, {opacity:1, width:0, delay: 0.5})
      .to(this.mini, 1, { autoAlpha: 1, width: 306 })
      .set(this.watches, {opacity:1, width:0})
      .to(this.watches, 1, { autoAlpha: 1, width: 276 })

      .to(this.mini, 0.5, { autoAlpha: 0, delay: 1 })
      .to(this.watches, 0.5, { autoAlpha: 0, delay: -0.5 })

      .set(this.sky, {opacity:1, width:0})
      .to(this.sky, 1, { autoAlpha: 1, width: 207 })
      .set(this.planes, {opacity:1, width:0})
      .to(this.planes, 1, { autoAlpha: 1, left:120, width: 260 })

      .to(this.planes, 0.5, { autoAlpha: 0, delay: 1 })
      .to(this.sky, 1, { left: 215, bottom:300, width: 137 })
      .to(this.mini, 0.1, { autoAlpha: 0, left: 0, bottom:340, width: 0, delay: -2 })
      .to(this.mini, 1, { autoAlpha: 1, left: 0, width: 208, delay: -1 })

      .to(this.mealText, 1, { autoAlpha: 1, left: 0, width: 331, delay: -1 })
