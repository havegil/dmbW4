...
/* 499_fvm_with_299_sub_la_only_classic_meals */
export default class FVMVersion9Classic extends Component {

  constructor(props) {
    super(props)
    this.item1 = API.loc(`oven_roasted_chicken_meal_price_6in`)
  ...
  render() {
    return (
      <div className='c-ValueClassic2017w8c'>
