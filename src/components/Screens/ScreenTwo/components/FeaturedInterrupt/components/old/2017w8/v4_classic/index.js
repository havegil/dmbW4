...
/* 499_fvm_with_299_sub_with_steak_classic_meals */
export default class FVMVersion4Classic extends Component {

  constructor(props) {
    super(props)
    this.item1 = API.loc(`tuna_meal_price_6in`)
    this.item2 = API.loc(`soct_meal_price_6in`)
    this.item3 = API.loc(`turkey_breast_meal_price_6in`)
    this.item4 = API.loc(`italian_bmt_meal_price_6in`)
  }
