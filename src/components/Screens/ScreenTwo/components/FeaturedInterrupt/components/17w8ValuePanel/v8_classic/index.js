...
/* 499_fvm_with_steak_classic_meals */
export default class FVMVersion8Classic extends Component {

  constructor(props) {
    super(props)
    this.item1 = API.loc(`tuna_meal_price_6in`)
    this.item2 = API.loc(`oven_roasted_chicken_meal_price_6in`)
    this.item3 = API.loc(`subway_club_meal_price_6in`)
    this.item4 = API.loc(`steak_and_cheese_meal_price_6in`)
  }
