...
//2021w1
import GoPro from '../components/2021w1/Gopro';
import ProTip from '../components/2021w1/ProTip';

//2021w2
import FreshlyMade from '../components/2021w2/FreshlyMade';

//2021w3
import FreshMelts from '../components/2021w3/FreshMelts';

//2021w4
import CaliFresh from '../components/2021w4/CaliFresh';
import FootlongPro from '../components/2021w4/FootlongPro';

//2021w5
import BajaSteak from '../components/2021w5/BajaSteak';

//2021w6
import PreloadedToPerfection from '../components/2021w6/PreloadedToPerfection';
...
//2022w4
import AllNewMenu from '../components/2022w4/AllNewMenu';
...
const components = {
  ...
  //2021w2
  w2_steak_turkey: <FreshlyMade />,
  melts: <FreshMelts />,

  //2021w3

  //2021w4
  cali_fresh: <CaliFresh />,
  footlong_pro: <FootlongPro />,

  //2021w5
  baja_steak: <BajaSteak />,
...
if (API.loc('serves_coca_cola')) {
  fixed_promo = 'preloaded_to_perfection';
} else {
  fixed_promo = 'preloaded_to_perfection';
}

let fixed_promo_active = true;
...
export default [
  ...
  /* UNCOMMENT THIS FOR NORMAL PLAYLIST
  {
...
/* TEMPORARY FIXED PROMO PLAYLIST BELOW */
  {
    id: 'd202c828-daed-490c-ad43-c611b411efb5',
    frames: [
      { 
        component: <AllNewMenu />,
        duration: 10000000,
      },
      {
        component: <AllNewMenu />,
