...
import AllNewMenuBackground from '../images/all_new_menucheesesteaks_bkg.jpg'
import AllNewSeries from '../images/all_new_series.jpg'
import AllNewCheeseSteaks from '../images/strd_cheesesteaks.jpg'
...
export default class AllNewMenu extends Component {

    render() {

    let bg = AllNewMenuBackground;
    ...
    return (
        <div className="all-new-menu">
            ...
            <div className="cheesesteaks-half" style={{ left: layoutDirection == "R2L" ? "0" : "auto", right: layoutDirection == "R2L" ? "auto" : "0" }}>
                ...
                {/* <p className="price price--philly-fl">${philyPrice12} </p>
                <p className="price price--philly-pro">${philyPricePro} </p> */}
