...
export default class BajaSteak extends Component {
    ...
    componentDidMount() {
        ...
        timeline
        .set([this.Frame1New, this.Frame1Baja, this.Frame1Steak, this.Frame1Arrow], {x: 1280})
        .set([this.Frame2New, this.Frame2Steak, this.Frame2Arrow], {x: -1280})
        .set([this.Frame2], {x: 1280})
        .set([this.Frame3New, this.Frame3Bread, this.Frame3Arrow], {y: -1080})
        .set([this.Frame3], {y: 1080})
        .set([this.Frame4New, this.Frame4Sauce, this.Frame4Arrow], {x: 1280})
        .set([this.Frame4], {x: -1280})
        .set([this.Frame5Sub], {x: -1280})
        .set([this.Frame5Drink], {x: 1280})
        .set([this.Frame5New, this.Frame5Baja, this.Frame5Arrow], {y: -1080})


        .to([this.Frame1New, this.Frame1Baja, this.Frame1Steak, this.Frame1Arrow], 0.75, {x: 0}, 0.25)
        .to([this.Frame1New, this.Frame1Baja, this.Frame1Steak, this.Frame1Arrow, this.Frame1, this.Frame1Featuring], 0.25, {autoAlpha: 0}, '+= 2')

        .to([this.Frame2New, this.Frame2Steak, this.Frame2Arrow, this.Frame2], 0.75, {x: 0}, '+= 0.5')
        .to([this.Frame2New, this.Frame2Steak, this.Frame2Arrow, this.Frame2], 0.25, {autoAlpha: 0}, '+= 2')

        .to([this.Frame3New, this.Frame3Bread, this.Frame3Arrow, this.Frame3], 0.75, {y: 0}, '+= 0.5')
        .to([this.Frame3New, this.Frame3Bread, this.Frame3Arrow, this.Frame3], 0.25, {autoAlpha: 0}, '+= 2')

        .to([this.Frame4New, this.Frame4Sauce, this.Frame4Arrow, this.Frame4], 0.75, {x: 0}, '+= 0.5')
        .to([this.Frame4New, this.Frame4Sauce, this.Frame4Arrow, this.Frame4], 0.25, {autoAlpha: 0}, '+= 2')

        .to([this.Frame5Sub, this.Frame5Drink, this.Frame5New, this.Frame5Baja, this.Frame5Arrow], 0.75, {x: 0, y: 0}, '+= 0.5')
