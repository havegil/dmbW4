...
export default class Cheesesteak extends Component {
	...
	componentDidMount() {
		...
		.set([this.Frame2Sub, this.Frame3Sub], {width: "1500px", top: -180})

		.to([this.Frame2Sub, this.Frame2Border], 0.5, {autoAlpha: 1}, "+=5")

		.to([this.Frame3Sub, this.Frame3Border], 0.5, {autoAlpha: 1}, "+=5")

		.to(this.FinalFrame, 1, {autoAlpha: 1}, "+=5")
	...
	return(
		<div className="c-cheesesteak-dual">
