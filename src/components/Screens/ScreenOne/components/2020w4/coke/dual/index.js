...
export default class Coke2020W4 extends Component {
    ...
    componentDidMount() {
        ...
        timeline
        .set([this.Frame2, this.Frame3, this.BG, this.Coke, this.Text], {autoAlpha: 0})
        .set(this.Coke, {left: 100})

        .to([this.Frame2], 0.5, {autoAlpha: 1}, "+=1.5")
        .to([this.Frame3, this.BG], 0.5, {autoAlpha: 1}, "+=1.5")
        .to(this.Coke, 1, {autoAlpha: 1}, "+=0.5")
        .to(this.Text, 1, {autoAlpha: 1}, "+=0.5")
    }

    render() {
    return (
        <div className="coke-2020-w4-dual">
