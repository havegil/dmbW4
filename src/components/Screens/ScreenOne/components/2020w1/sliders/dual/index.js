...
export default class Sliders extends Component {
	...
	componentDidMount() {
		...
		.set([this.ChipLayer3, this.ChipLayer2, this.ChipLayer1], {top: "180px"})

		.to(this.Frame1, 3, {left: "-300px", ease:Linear.easeNone})
		.to([this.Frame2,this.ChipLayer1,this.ChipLayer2,this.ChipLayer3], .5, {autoAlpha: 1}, "+=2")
		.to([this.DrinkB, this.Frame3Text], 0.5, {autoAlpha: 1}, "+=2")
