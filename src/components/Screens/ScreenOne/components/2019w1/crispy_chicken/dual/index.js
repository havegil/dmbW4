...
// Build DOM
let domClass = 'c-CrispyChicken2019w1Dual'
...
export default class CrispyChicken2019w1Dual extends Component
{
  ...
  componentDidMount() {
    ...
    let timeline = new TimelineMax()
      .set(
        [C.bg1,C.sub1Price6,C.sub1price12,C.wrapPrice],
        { autoAlpha: 1 }
      )
      .set([
      ...
      .to([C.frame1, C.frame1bg, C.frame1text1, C.frame1text2], 0.5,
        { autoAlpha: 1 }, 3)

      .set([C.frame1bg, C.frame1text3, C.frame1text4],
            { autoAlpha:1, left: -601 }, 6)

      .set([C.frame1text1, C.frame1text2],
              { autoAlpha: 0 }, 6)

      .set([C.frame2, C.frame2bg, C.frame2text1, C.frame2text2],
          { autoAlpha: 1 }, 9)

      .set([C.frame2bg, C.frame2text3, C.frame2text4],
          { autoAlpha: 1, left: -901 }, 12)

      .set([C.frame2text1, C.frame2text2],
            { autoAlpha: 0 }, 12)
      
      .set([C.frame1, C.frame1bg, C.frame1text1, C.frame1text2, C.frame1text3, C.frame1text4],
          { autoAlpha: 0 }, 11)

      .set([C.frame2, C.frame2bg, C.frame2text1, C.frame2text2, C.frame2text3, C.frame2text4],
          { autoAlpha: 0 }, 15)
      
    // timeline
    //   .to([C.frame1, C.frame1bg, C.frame1text1], 0.5,
    //   { autoAlpha: 1 }, 3)

    //   .to([C.frame1bg, C.frame1text1, C.frame1text2, C.frame1text3, C.frame1text4], 5,
    //   { left: -601 }, 2.6)
    ...
    //   .to([C.frame2, C.frame2bg, C.frame2text1], 0.5,
    //   { autoAlpha: 1 }, 10)

    //   .to([C.frame2bg, C.frame2text1, C.frame2text2, C.frame2text3, C.frame2text4], 7,
    //   { left: -901 }, 10)
    ...
    //   .to([C.frame2, C.frame2bg, C.frame2text1, C.frame2text2, C.frame2text3, C.frame2text4], 0.5,
    //   { autoAlpha: 0 }, 19)
