...
export default class ChickenSignaturePromoQuad extends Component {
...
componentDidMount() {
    new TimelineMax()
      ...
      .set(this.frame1, { autoAlpha: 0, delay: 1.5 })
      .set(this.frame2, { autoAlpha: 1 })
      .to(this.bg2, 1.5, { left: "-=50" })

      .set(this.frame2, { autoAlpha: 0 })
      .set(this.frame3, { autoAlpha: 1 })
      .to(this.bg3, 1.5, { left: "+=50" })

      .set(this.frame3, { autoAlpha: 0 })
      .set(this.frame4, { autoAlpha: 1 })

      .set(this.frame4, { autoAlpha: 0, delay: 1.5 })
      .set(this.frame5, { autoAlpha: 1 })
      .to(this.bg5, 1.5, { left: "-=50" })

      .set(this.frame5, { autoAlpha: 0 })
      .set(this.frame6, { autoAlpha: 1 })
      .to(this.bg6, 1.5, { left: "-=50" })
