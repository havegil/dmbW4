...
export default class FreshMelts extends Component {
    ...
    componentDidMount() {
        ...
        .set([this.Frame1Text1, this.Frame1Text2,this.Frame5Text1,this.Frame5Text2], {y: 100})
        .set(this.Frame2, {x: -300})
        .set(this.Frame3, {x: -200})
        .set(this.Frame4, {x: -300})

        //--------------------------------------------//

        .to(this.Frame1Text1, 0.5, {y: 0, autoAlpha: 1}, "+=0.5")
        .to(this.Frame1Text2, 0.5, {y: 0, autoAlpha: 1}, "+=0.25")
        ...
        .to(this.Frame3, 3, {x:-500, ease: Linear.easeNone}, "-=1")

        .to([this.Frame4,this.Frame4Text], 0, {autoAlpha: 1}, "-=1")
        .to(this.Frame4, 3, {x:0, ease: Linear.easeNone}, "-=1")

        .to(this.Frame5, 0, {autoAlpha: 1}, "+=0")
        .to(this.Frame5Text1, 0.5, {y: 0, autoAlpha: 1}, "+=0.5")
        .to(this.Frame5Text2, 0.5, {y: 0, autoAlpha: 1}, "+=0.25")
