...
const imageLookup = {
  'sides_chili': imgBacon,
  'sides_brownie': imgBacon,
  'sides_soup': imgBacon,
        ...
        <div className='footer-1' ref={(node) => this.footer1 = node }>
          ...
          <div className='f-col f-1'>
            <div className='wrapper'>
              <img src={imgBacon}/>
              <div className="info">
              <span className='title'>Bacon </span>
              <span className="new">new</span>
              <div className='pricing'>
                <span>80 | 160 added cal <SodiumWarning showSmall/></span>
                <strong>${extras_bacon_price_6in} | ${extras_bacon_price_12in}</strong><br/>
          ...
          <div className='f-col f-2'>
            <div className='wrapper'>
              ...
              <div className='pricing'>
              <span>40-60&nbsp;&nbsp;|&nbsp;&nbsp;80-120  added cal</span>
                <strong>${extras_cheese_price_6in}&nbsp;&nbsp;|&nbsp;&nbsp;${extras_cheese_price_12in}</strong><br/>
          ...
          <div className='f-col f-3'>
            <div className='wrapper'>
              <img src={imgPepperoni}/>
              <div className="info">
              <div className='title'>PEPPERONI</div>
              <div className='pricing'>
                <span>70&nbsp;&nbsp;|&nbsp;&nbsp;140 added cal <SodiumWarning showSmall/></span>
                <strong>${extras_pepperoni_price_6in} &nbsp;|&nbsp; ${extras_pepperoni_price_12in}</strong><br/>
