...
export default class UltimateSpicyInterrupt extends Component {
  ...
  componentDidMount() {
    ...
    new TimelineMax()
      ...
      .set(this.leftSub, { autoAlpha:1 })
      .set(this.rightSub, { autoAlpha:1, left:"auto", right:0 })

      .set(this.leftSubShadow, { autoAlpha:0, left: -10 })
      .set(this.rightSubShadow, { autoAlpha:0, left:"auto", right:10})

      .set(this.cheese, { autoAlpha: 1, left:3730, top: 400, width: 10, height: 430 })
      ...
      .to(this.rightSubWrapper, 3, { left:5540 }, 0)
      ...
      .to(this.rightSubWrapper, 0.2, { left: "+=220", width: "-=220" }, 3.0)
  ...
  render() {
    return (
      <div className='ultimateSpicyInterrupt' ref={(node) => this.main = node}>
